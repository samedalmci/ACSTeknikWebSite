        ...
        <section className="relative h-[70vh] flex items-center overflow-hidden">
            ...
            <div className="absolute inset-0 z-0">
                ...
                <div 
                    ...
                    style={{ 
                        ...
                        backgroundImage: 'radial-gradient(circle at center, rgba(42, 84, 153, 0.8) 0%, rgba(42, 84, 153, 0.2) 100%)',
            ...
            <div className="relative z-10 px-12 max-w-3xl flex flex-col justify-center items-start h-full"> 
                ...
                <p className="text-left text-lg md:text-xl font-light mb-10 leading-relaxed text-gray-200">
                    Bosch, Gaggenau, Profilo ve Siemens marka beyaz eşyalarınız için
                    Muğla genelinde 7/24 hızlı teknik servis desteği sunuyoruz.
                    Hemen arayarak arıza kaydı oluşturabilirsiniz.
                </p>
