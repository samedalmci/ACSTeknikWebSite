    ...
    <footer className="bg-gray-50 py-16">
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-4 gap-8 mb-12">
          {" "}
          {/* gap-0 -> gap-8 olarak güncellendi */}
          ...
          <div className="md:col-span-1">
            ...
            <p className="text-sm text-gray-600 mt-4">
              Muğla'nın tüm ilçelerine Bosch, Gaggenau, Profilo ve Siemens marka
              cihazlar için Yetkili Servis hizmeti.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-gray-600 text-sm">
              <li>
                <a
                  href="mailto:info@acsteknik.com"
              ...
              <li>
                <a
                  ...
                  className="font-bold text-lg text-red-600 hover:text-red-700 transition-colors"
                >
                  📞 +90 (544) 673 47 60
                </a>
              </li>
              <li>
                <a
                  href="https://maps.app.goo.gl/adresiniz"
                  target="_blank"
        ...
        <div className="border-t border-gray-300 pt-8 text-center text-gray-600 text-sm">
          <p>
            &copy; 2025 ACS TEKNİK Beyaz Eşya ve Klima Çözümleri. Tüm hakları
            saklıdır.
          </p>
        </div>
      </div>
